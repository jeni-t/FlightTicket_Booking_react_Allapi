...
const handleSelectOrigin = (code) => {
  ...
  return (
    <div>
       <div className="relative min-h-screen bg-cover bg-center" style={{ backgroundImage: "url('/public/flight-ticket-fare.jpg')"}}>
...
{selectedFlight && (
    <div className="relative mt-4">
        ...
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/public/image-flight.jpeg')" }}></div>
